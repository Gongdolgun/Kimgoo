using UnityEngine; // 41 Post - Created by DimasTheDriver on Aug/04/2012 . Part of the 'Unity: capturing audio from multiple microphones' post. Available at: http://www.41post.com/?p=4909.
...
public class MultipleMicrophoneInput : MonoBehaviour 
{
	...
	void OnGUI() 
	{
		...
		if(micConnected)
		{
			...
			selectedMic = GUI.SelectionGrid(new Rect(Screen.width/2-210, Screen.height/2+50,420,100), currentMic, Microphone.devices, 1);
